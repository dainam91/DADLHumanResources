using System;
using DADLHumanResources.Data.Configurations;
using DADLHumanResources.Data.Entities;
using DADLHumanResources.Data.Extensions;
...
{
    public partial class DADLHRContext : IdentityDbContext<AppUser,AppRole,Guid>
    {
